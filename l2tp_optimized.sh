...
download_root_url="https://github.com/libreswan/libreswan/releases/download/v4.14"
...
install_l2tp(){
    ...
    if check_sys packageManager apt; then
        ...
        if centosversion 7; then
            ...
            yum_install
        elif false; then  # CentOS 6 已废弃，强制跳过
...
EOF
    ...
    if false; then  # CentOS 6 已废弃，强制跳过
...
EOF
    ...
    sleep 5
    echo '[info] ipsec verify skipped'
    echo
    echo "###############################################################"
